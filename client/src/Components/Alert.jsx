...
const Alert = (props) => {
    ...
    const handleclosebutton = () => {
        document.querySelector('.close_alert').classList.toggle('hidden');
    }

    return (
        <>
            {props.alert && <div id="alert-2" className={props.alert.type === "danger" ? "close_alert flex p-4 mb-4 text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" : "flex p-4 mb-4 text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400"} role="alert" style={{ "position": "absolute", "top": 0,"left":'50%' }}>
                ...
                <button type="button" onClick={handleclosebutton} className={props.alert.type === "danger"?"ml-auto -mx-1.5 -my-1.5 bg-red-50 text-red-500 rounded-lg focus:ring-2 focus:ring-red-400 p-1.5 hover:bg-red-200 inline-flex h-8 w-8 dark:bg-gray-800 dark:text-red-400 dark:hover:bg-gray-700":"ml-auto -mx-1.5 -my-1.5 bg-green-50 text-green-500 rounded-lg focus:ring-2 focus:ring-green-400 p-1.5 hover:bg-green-200 inline-flex h-8 w-8 dark:bg-gray-800 dark:text-green-400 dark:hover:bg-gray-700"} data-dismiss-target="#alert-2" aria-label="Close">

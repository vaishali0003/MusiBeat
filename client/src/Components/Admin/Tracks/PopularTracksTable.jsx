...
const PopularTracksTable = (props) => {
   ...
   const editNote = (currentsong) => {
      document.querySelector('.songEditModal').classList.toggle('hidden')
      ...
      <>
         <div className="data_table">
            <div className="modalpart">
               <div id="authentication-modal" tabIndex="-1" aria-hidden="true" className="songEditModal fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full">
